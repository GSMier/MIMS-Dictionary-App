  ...
  return (
    <div className="flex gap-5 items-center group">
      <label className="relative inline-flex items-center cursor-pointer">
        ...
        <div
          onClick={handleClick}
          className="w-10 h-5 peer-focus:outline-none rounded-full peer bg-[#757575] dark:bg-[#757575] peer-checked:after:translate-x-[130%] rtl:peer-checked:after:-translate-x-full after:content-[''] after:absolute after:top-[2.5px] after:start-[4px] after:bg-white after:rounded-full after:h-[14px] after:w-[14px] after:transition-all dark:border-gray-600 peer-checked:bg-[#A445ED] hover:bg-[#A445ED] peer-checked:hover:bg-[#7C3AED] transition-colors duration-200"
        ></div>
      </label>
      <div className="grid">
        {resolvedTheme === "dark" && (
          <svg
            className={`svgtest  transition-all duration-300`}
